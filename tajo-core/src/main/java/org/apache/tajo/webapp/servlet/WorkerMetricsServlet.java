...
public class WorkerMetricsServlet extends AbstractExecutorServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    this.worker = (TajoWorker) StaticHttpServer.getInstance().getAttribute("tajo.info.server.object");
  }
  ...
  public void service(HttpServletRequest request,
    ...
    try {
      ...
      if("getMetrics".equals(action)) {
        if(this.worker!=null){
          TreeMap<String, FlexibleQueue<Map<Long, Object>>> treeMap = new TreeMap<String, FlexibleQueue<Map<Long, Object>>>( this.worker.getThreadableMetricsChunk().getMetrics());
